...
public class LdaMethod {
	...
	public static int CLASS_DEFAULT = 50;
	public static int EMMAX_DEFAULT = 200;
	public static int DEMMAX_DEFAULT = 10;
	public static double EPSILON_DEFAULT = 1.0e-5;

	public static void usage() {
		//System.out.print("usage: lda -N classes [-I emmax] [-D demmax] [-E epsilon] train model\n");
	}

	
	public static void lda(String[] args) {
